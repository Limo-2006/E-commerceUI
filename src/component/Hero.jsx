...
const Hero = () => {
  ...
  {/* Small Label */}
  <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">OUR BESTSELLERS</p>
  ...
  {/* Subtext */}
  <p className="text-gray-500 mt-2 text-sm sm:text-base">Explore Timeless Collections</p>
  
  {/* Button */}
  <button className="mt-4 sm:mt-6 px-5 py-2 sm:px-6 sm:py-3 bg-[#008080] text-white font-semibold text-sm sm:text-base rounded-md hover:bg-teal-600 transition-colors w-max">
    SHOP NOW
  </button>
</div>
